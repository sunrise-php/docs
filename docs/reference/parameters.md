...
Part of the package: [sunrise/awesome-skeleton](/docs/packages/sunrise/awesome-skeleton/)
...
Part of the package: [sunrise/http-curl-client](/docs/packages/sunrise/http-curl-client/)
...
### router.payload_decoding_middleware.error_message
...
### router.payload_decoding_middleware.error_status_code
